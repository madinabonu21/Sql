...
-UPDATE  students
SET  StudentID = 1 , name='Dilnavoz' , age=20
WHERE StudentID = 1
...
9.
Step 1. We have to  click the link below then upload a file . Then  go to “my computer” find the downloaded file then click on the right and save to C disk
